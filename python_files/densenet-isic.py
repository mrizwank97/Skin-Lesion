...
def build_callbacks():
    checkpointer = ModelCheckpoint(filepath="../models/isic-fcdn-bin-iou.h5", monitor='val_mean_iou', verbose=1, save_best_only=True, save_weights_only=False, mode='max')
    ...
    csv = keras.callbacks.CSVLogger('../logs/isic-fcdn-bin-iou.csv', separator=',')
